...
cd ${name} ; rm -rf images/vbmeta.img images/revserve.img ; mv vbmeta.img images ; zip -r ${name}.zip * ; mv ${name}.zip ../ ; cd ../ ; rm -rf ${name} ; rm -rf 666 ; mkdir 666 ; mv ${name}.zip 666 ; wget https://raw.github.com/zhlhlf/text/main/onedrive_mount.sh ; sh onedrive_mount.sh $RCK 临时存放文件 ;
