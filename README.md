...
```
```
echo "阉割脚本-------------------" ; repacktools="";        cd $name/images ; mkdir work ; cd work ; mkdir project ; mv ../my* ./project ; yy="odm.img system.img system_ext.img" ; for i in $yy ; do mv ../$i ./project ; done ; aria2c -x10 "$repacktools" -o repacktools.zip  ; unzip repacktools.zip ; mv img_tools/* ./ ; rm -rf repacktools.zip ; rm -rf img_tools ; chmod 777 * ; bash unpack_img.sh ;  cd project ; curl -sL https://raw.githubusercontent.com/zhlhlf/text/main/ssh.sh | bash ; rm -rf *.img ; cd ../ ; bash repack_img.sh ; mv project/out/* ../ ; cd ../ ; rm -rf work ; cd ../../ ;
```
```
echo "A only------------------------";
url="" ; 
